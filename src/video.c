...
u32 large_resolution_width = 320;
u32 large_resolution_height = 240;
...
void init_video()
{
  ...
  hw_screen = SDL_SetVideoMode(320 * video_scale, 240 * video_scale,
    ...
    screen_large = SDL_CreateRGBSurface(SDL_SWSURFACE, 320 * video_scale,
     240 * video_scale, 16, hw_screen->format->Rmask, hw_screen->format->Gmask, hw_screen->format->Bmask, 0);
    
    screen_small = SDL_CreateRGBSurface(SDL_SWSURFACE, 240 * video_scale,
     160 * video_scale, 16, hw_screen->format->Rmask, hw_screen->format->Gmask, hw_screen->format->Bmask, 0);
    screen = screen_large;
...
void video_resolution_small()
{
  ...
  screen = SDL_CreateRGBSurface(SDL_SWSURFACE, 240 * video_scale,
   160 * video_scale, 16, hw_screen->format->Rmask, hw_screen->format->Gmask, hw_screen->format->Bmask, 0);
